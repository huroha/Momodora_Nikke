...
void CNpcEnter_d3::FinalTick()
{
    if (CFontMgr::GetInst()->IsComplete(m_Dialog3) && (KEY_TAP(KEY::F) || KEY_TAP(KEY::A)))
    {
        GetStateMachine()->ChangeState(L"CNpcEnter_d1");
    }
}

void CNpcEnter_d3::Enter()
{
    ...
    m_Dialog3 = sDialogScript->GetDialog2();
    CFontMgr::GetInst()->SetFadeActive(m_Dialog3, true);
}

void CNpcEnter_d3::Exit()
{
